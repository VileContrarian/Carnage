...
AGAME307RNA_CARnageHud::AGAME307RNA_CARnageHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void AGAME307RNA_CARnageHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if (bWantHUD == true)
	{
		...
		AGAME307RNA_CARnagePawn* Vehicle = Cast<AGAME307RNA_CARnagePawn>(GetOwningPawn());
